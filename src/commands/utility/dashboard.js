...
export const data = new SlashCommandBuilder().setName('dashboard').setDescription('View dashboard foundation status.');

export function getDashboardUrl(source) {
  return source?.appContext?.runtimeConfig?.dashboardUrl ?? null;
}
