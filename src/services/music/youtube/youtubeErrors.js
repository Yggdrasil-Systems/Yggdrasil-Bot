...
export const YT_INVALID_QUERY = 'YT_INVALID_QUERY';
export const YT_METADATA_FAILED = 'YT_METADATA_FAILED';
export const YT_PLAYLIST_FAILED = 'YT_PLAYLIST_FAILED';
export const YT_SEARCH_FAILED = 'YT_SEARCH_FAILED';
export const YT_STREAM_FAILED = 'YT_STREAM_FAILED';
